...
const Facility = () => {
  ...
  return <section id="facility" className="py-24 lg:py-32 bg-muted/30">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <ScrollReveal delay={0.2} className="max-w-5xl mx-auto mb-16">
          ...
          loop: true
            ...
            <CarouselContent className="-ml-4">
              {galleryImages.map((image, index) => <CarouselItem key={index} className="pl-4 md:basis-1/2 lg:basis-1/3">
                  <div className="group relative overflow-hidden rounded-2xl aspect-[4/3] card-soft hover:card-elevated transition-all duration-300">
                    <img src={image.image} alt={image.title} className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 max-w-4xl mx-auto">
          ...
          value: "16-50s",
          label: "Count Range"
        }].map((stat, index) => <ScrollReveal key={stat.label} delay={0.1 * index}>
